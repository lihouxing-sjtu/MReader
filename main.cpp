...
int main(int argc, char *argv[]) {
  ...
  QQuickVTKRenderItem *gViewRender;
  ModelReader gModelRender;
  ...
  qmlRegisterSingletonInstance<ModelReader>("ModelReader", 1, 0, "ModelReader",
                                            &gModelRender);
  ...
  gModelRender.setRenderItem(gViewRender);
